...
public abstract class Enemy extends GameObject{
    ...
    public void draw(Canvas canvas, GameDisplay gameDisplay) {
        ...
        if (xSpeed == 0)  {
            if(hero.getxPosition() > xPosition) canvas.drawBitmap(Model[0], gameDisplay.gameToDisplayCoordinatesX(xPosition - Model[0].getWidth()/2), gameDisplay.gameToDisplayCoordinatesY(yPosition - Model[0].getHeight()/2), null);
            else canvas.drawBitmap(Model[1], gameDisplay.gameToDisplayCoordinatesX(xPosition - Model[1].getWidth()/2), gameDisplay.gameToDisplayCoordinatesY(yPosition - Model[1].getHeight()/2), null);
        }
    }
